...
/// Official / major city list used for the map weather markers.
...
String predictionRegionForCity(MalaysianCity city) {
  switch (city.state) {
    case 'Johor':
    case 'Melaka':
      return 'Johor';
...
String predictionRegionForCityName(String cityName) {
  for (final city in kMalaysianCities) {
    if (city.name == cityName) {
      return predictionRegionForCity(city);
    }
  }
  return 'Kuala Lumpur';
}
