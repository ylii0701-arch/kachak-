...
import 'photography_assistant_screen.dart';
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                _item(context, 3, Icons.camera_outlined, Icons.camera, 'Assist'),
                _item(context, 4, Icons.favorite_border, Icons.favorite, 'Saved'),
              ],
            ),
          ),
        ),
        ...
        children: [
          ...
          IndexedStack(
            ...
            children: [
              ...
              const MapScreen(),
              const PhotographyAssistantScreen(),
              SavedScreen(
